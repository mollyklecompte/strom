...
class Event(dict, metaclass=ABCMeta):
...
event_builder = {'turn': Event(create_turn_rules, base_measure_type='geo',required_input_settings=['turn_value'], default_settings={'units':"deg", 'heading_type':"bearing", 'swap_lon_lat': True, 'window_len':1, 'logical_comparision':"AND"})}
