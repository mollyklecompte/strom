...
class TestCoordinator(unittest.TestCase):
    def setUp(self):
        ...
        self.dstream_template = {"stream_name": "driver_data", "version": 0, "stream_token": "abc123", "timestamp": None, "measures": {"location": {"val": None, "dtype": "float"}, "measure2": {"val": None, "dtype": "int"}}, "fields": {"region-code": {}}, "user_ids": {"driver-id": {}, "id": {}}, "tags": {}, "foreign_keys": [], "filters": [], "dparam_rules": [], "event_rules": {}}
        self.queried_template = {"stream_name": "driver_data", "version": 0, "stream_token": "abc123", "timestamp": None, "measures": {"location": {"val": None, "dtype": "float"}, "measure2": {"val": None, "dtype": "int"}}, "fields": {"region-code": {}}, "user_ids": {"driver-id": {}, "id": {}}, "tags": {}, "foreign_keys": [], "filters": [], "dparam_rules": [], "event_rules": {}, "_id": "chadwick666"}
    ...
    def test_store_json(self):
        ...
        queried_derived_id = self.coordinator.mongo.get_by_id(inserted_derived_id, 'derived', token=self.queried_template["stream_token"])
        queried_event_id = self.coordinator.mongo.get_by_id(inserted_event_id, 'event', token=self.queried_template["stream_token"])
